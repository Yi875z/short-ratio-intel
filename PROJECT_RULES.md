...
- **データソースと取得条件**:
  - 空売り比率: JPX公開PDF（`jpx_pdf_client.py`）が第一候補、stock-marketdata.com のスクレイパー
    ...
    **一覧ページが当月ぶんの全営業日、月別アーカイブが過去12ヶ月ぶんの全営業日**を持つ
    （`00-archives-01.html` … `-12.html`。01が前月、12が13ヶ月前。13以降は404）。
    2026-09-03 実測: 一覧=2026/09/01〜09/03、archives-01=8月20日・-02=7月22日・-03=6月22日で、
    いずれも当DBが持つその月の営業日と**完全一致**（差分ゼロ）。月の一部ではなく全営業日が載る。
